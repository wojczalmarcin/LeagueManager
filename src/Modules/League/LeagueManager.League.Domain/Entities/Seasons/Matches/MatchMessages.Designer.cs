...
namespace LeagueManager.League.Domain.Entities.Seasons.Matches {
    ...
    internal class MatchMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Match date cannot be set to be in the past..
        /// </summary>
        internal static string MatchDateValidation {
            get {
                return ResourceManager.GetString("MatchDateValidation", resourceCulture);
            }
        }
    }
}
